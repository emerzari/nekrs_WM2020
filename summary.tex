...
\caption{NekRS GPU/CPU and Nek5000 CPU weak-scaling (top) and strong-scaling (bottom) performance on OLCF's Summit.
...
Figure~\ref{fig:nekrs1} shows the recent performance of weak and strong scalings on Summit's GPUs 
and CPUs for 17$\times$17 rod-bundle turbulent flow simulations for $Re=5000$.
%We analyze more detail here the performance of NekRS vs. Nek5000 for fuel assemblies. 
...
Figure~\ref{fig:nekrs1}, top, shows weak scaling of Nek5000 and NekRS with increasing mesh counts,
...
Figure~\ref{fig:nekrs1}, bottom, shows strong scaling performance with $E = 277000$ and $N = 7$,
total grid points of $n = 95,011,000$. NekRS GPU runs used 4M, 3M, 2.5M, 2.2M, 1.9M, 1.7M and 1.5M
grid points per GPU as the number of nodes increase from 4 to 10, demonstrating 80\% efficiency 
at 1.9M points per GPU.
